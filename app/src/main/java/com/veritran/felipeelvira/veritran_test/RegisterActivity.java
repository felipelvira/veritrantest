...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthAdapter = ServiceClient.getClientInstance(RegisterActivity.this).create((AuthService.class));
        ...
        mEmailSignInButton = (Button) findViewById(R.id.register_button);
    ...
    private void attemptRegister() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            Call<VeritranUser> registerCall = mAuthAdapter.register(new AuthBody(email, password));
            registerCall.enqueue(new Callback<VeritranUser>() {
                @Override
                public void onResponse(Call<VeritranUser> call, Response<VeritranUser> response) {
                    ...
                    //Preferences.get(RegisterActivity.this).saveUser(response.body());
                    showProgress(false);
                    showLoginActivity();
